-- Drop existing objects from partial runs (safe for dev reset)
DROP TABLE IF EXISTS auditoria CASCADE;
DROP TABLE IF EXISTS usuario_empresa CASCADE;
DROP TABLE IF EXISTS usuario CASCADE;
DROP TABLE IF EXISTS pessoa_juridica_empresa CASCADE;
DROP TABLE IF EXISTS pessoa_fisica_empresa CASCADE;
DROP TABLE IF EXISTS pessoa_empresa CASCADE;
DROP TABLE IF EXISTS ordem_servico_expressa_empresa CASCADE;
DROP TABLE IF EXISTS ordem_servico_empresa CASCADE;
DROP TABLE IF EXISTS servico_ordem_servico CASCADE;
DROP TABLE IF EXISTS produto_ordem_servico CASCADE;
DROP TABLE IF EXISTS ordem_servico CASCADE;
DROP TABLE IF EXISTS ordem_servico_expressa CASCADE;
...
DROP SEQUENCE IF EXISTS usuario_empresa_id_seq;
DROP SEQUENCE IF EXISTS pessoa_juridica_empresa_id_seq;
DROP SEQUENCE IF EXISTS pessoa_fisica_empresa_id_seq;
DROP SEQUENCE IF EXISTS pessoa_empresa_id_seq;
DROP SEQUENCE IF EXISTS ordem_servico_expressa_empresa_id_seq;
DROP SEQUENCE IF EXISTS ordem_servico_empresa_id_seq;
DROP SEQUENCE IF EXISTS servico_ordem_servico_id_seq;
DROP SEQUENCE IF EXISTS produto_ordem_servico_id_seq;
DROP SEQUENCE IF EXISTS ordem_servico_id_seq;
DROP SEQUENCE IF EXISTS ordem_servico_expressa_id_seq;
...
DROP SEQUENCE IF EXISTS modelo_veiculo_id_seq;
DROP SEQUENCE IF EXISTS produto_id_seq;
DROP SEQUENCE IF EXISTS servico_id_seq;

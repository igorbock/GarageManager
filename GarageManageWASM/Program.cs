...
builder.Services.AddScoped<ServiceAbstract<Veiculo, VeiculoDTO>>(_ => new VeiculoService(new HttpClient(), "https://localhost:7134/api/veiculo"));
...
builder.Services.AddScoped<ServiceAbstract<OrdemServico, OrdemServicoDTO>>(_ => new OrdemServicoService(new HttpClient(), "https://localhost:7134/api/ordemservico"));
